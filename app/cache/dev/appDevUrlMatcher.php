    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/Commentaire')) {
            ...
            if (preg_match('#^/Commentaire/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'Commentaire')), array (  '_controller' => 'MOOC\\commentaireBundle\\Controller\\Commentaire2Controller::commenterAction',));
            }

            // Commentaireaff
            if (0 === strpos($pathinfo, '/Commentaireaff') && preg_match('#^/Commentaireaff/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'Commentaireaff')), array (  '_controller' => 'MOOC\\commentaireBundle\\Controller\\CommentaireController::ajoutAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/vote') && preg_match('#^/vote/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'vote')), array (  '_controller' => 'MOOC\\commentaireBundle\\Controller\\CommentaireController::ratingAction',));
        }

        // supprimer
        if (0 === strpos($pathinfo, '/supprimer') && preg_match('#^/supprimer/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'supprimer')), array (  '_controller' => 'MOOC\\commentaireBundle\\Controller\\CommentaireController::deleteAction',));
        }

        // modifier
        if (0 === strpos($pathinfo, '/modifier') && preg_match('#^/modifier/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'modifier')), array (  '_controller' => 'MOOC\\commentaireBundle\\Controller\\Commentaire2Controller::modifierAction',));
        }
