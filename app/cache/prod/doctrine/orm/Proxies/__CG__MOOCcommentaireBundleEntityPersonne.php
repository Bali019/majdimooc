 ...
 */
class Personne extends \MOOC\commentaireBundle\Entity\Personne implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MOOC\\commentaireBundle\\Entity\\Personne' . "\0" . 'id', '' . "\0" . 'MOOC\\commentaireBundle\\Entity\\Personne' . "\0" . 'nom');
        }
